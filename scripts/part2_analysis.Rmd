...
seqdata_RARE<-readRDS(
  "/Users/tobybregar/Git/git_test2/TB_AmpliconDatasets/data/processed_data/phyloseq/SPUN_Westside_Willing_with_FungalTraits.rds")
# seqdata_NOTRARE<-readRDS(
#  "/Users/tobybregar/Git/git_test2/TB_AmpliconDatasets/data/processed_data/phyloseq/STUDY_phyloseq_notrare.rds")
```
...
```{r}
physeq_EMF <- subset_taxa(seqdata_RARE, primary_lifestyle == "ectomycorrhizal")
##physeq_EMF <- subset_taxa(seqdata_RARE, primary_lifestyle == c("ectomycorrhizal, arbuscular_mycorrhizal, dung_saprotroph")
## bar plot

# Step 1: Merge samples by a grouping variable (e.g., "SampleType")
ps_merged <- physeq_EMF %>%
  merge_samples("stand_age")
...
# is this different?
```{r}
physeq_EMF2 <- subset_taxa(seqdata_RARE, lifestyle == "Saprotroph"
# physeq_EMF <- subset_taxa(seqdata_RARE, primary_lifestyle == c("ectomycorrhizal, arbuscular_mycorrhizal, dung_saprotroph")
## bar plot

# Step 1: Merge samples by a grouping variable (e.g., "SampleType")
ps_merged2 <- physeq_EMF2 %>%
  merge_samples("stand_age")
